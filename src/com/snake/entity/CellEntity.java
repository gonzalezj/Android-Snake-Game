...
/**
 *  This is a subclass of Sprite, provided by the game engine.
 *  The snake will have 2 body parts, the head and the tail
 *  The head will be Animated but the tail not.
 *  This is exaclty the same class as "AnimatedCellEntity" but
 *  this one does not animate each cell. 
 */
